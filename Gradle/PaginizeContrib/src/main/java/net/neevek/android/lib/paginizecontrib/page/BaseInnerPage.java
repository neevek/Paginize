...
public class BaseInnerPage extends InnerPage {
  ...
  public BaseInnerPage(ViewWrapper innerPageContainer) {
  ...
  protected final void setMenu(@MenuRes int menuResId) {
    ...
    ToolbarHelper.setupMenu(mToolbar, menuResId, new Toolbar.OnMenuItemClickListener() {
      ...
      public boolean onMenuItemClick(MenuItem item) {
        return BaseInnerPage.this.onMenuItemClick(item);
      }
    });
  }
  ...
  protected void onNavigationIconClicked(View v) {
    PageManager pageManager = getContext().getPageManager();
    if (pageManager.getTopPage() == getInnerPageContainer()) {
      pageManager.popPage(true);
    }
  }
